    ...
    <div className="p-6 text-slate-300 leading-relaxed">
      ...
      <ul className="list-disc list-inside space-y-2 text-slate-300">
        ...
        <li>
          ...
          <ul className="list-disc list-inside ml-6 mt-1 text-slate-400">
            <li>Group habits into categories like "Health" or "Productivity".</li>
            <li>Track "Yes/No" habits for the current week.</li>
          </ul>
        </li>
        <li>
          ...
          <ul className="list-disc list-inside ml-6 mt-1 text-slate-400">
            ...
            <li>Assign transactions to custom categories.</li>
            <li>View total balance and a detailed history of all transactions.</li>
          </ul>
        </li>
         <li>
