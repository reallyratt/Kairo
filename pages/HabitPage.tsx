...
const HabitRow: React.FC<HabitRowProps> = ({ habit, week, logs, onLogChange, onHabitClick }) => {
    ...
    return (
        <div className="flex gap-3 bg-slate-900/50 p-3 rounded-lg" style={{backgroundColor: 'var(--bg-tertiary)'}}>
                    ...
                    if (habit.type === HabitType.Number) {
                        return (
                            <input
                                ...
                                className="w-8 h-8 text-center bg-slate-700 rounded-md text-sm hide-arrows disabled:opacity-50"
        ...
        <div>
            {view === 'list' && (
                <>
                    ...
                    <div className="p-4 space-y-4">
                        {/* Week Navigator */}
                        <div className="bg-slate-900 rounded-2xl p-3 shadow-lg flex justify-between items-center" style={{backgroundColor: 'var(--bg-secondary)'}}>
