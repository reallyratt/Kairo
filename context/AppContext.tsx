...
export type Theme = 'dark' | 'light' | 'default' | 'monochrome';
...
const translations: Record<Language, Record<string, any>> = {
  en: {
    ...
    settings: { language: "Language", theme: "Theme", dark: "Dark", light: "Light", default: "Default", monochrome: "Monochrome", back: "Back to the App" },
  ...
  id: {
    ...
    settings: { language: "Bahasa", theme: "Tema", dark: "Gelap", light: "Terang", default: "Default", monochrome: "Monokrom", back: "Kembali ke Aplikasi" },
    ...
    calendar: { add: "Tambah Acara", manage: "Kelola Kalender", overview: "Gambaran Umum", addCalendar: "Tambah Kalender Baru", eventsForDate: "Acara untuk {date}", eventsForMonth: "Acara untuk {month}", editEvent: "Edit Acara", createEvent: "Buat Acara Baru", confirmDeleteRecurringTitle: "Hapus Acara Berulang", confirmSaveRecurringTitle: "Simpan Acara Berulang", confirmUnsavedTitle: "Perubahan Belum Disimpan", eventNamePlaceholder: "Nama Acara (Wajib)", descriptionPlaceholder: "Deskripsi (Opsional)", repetition: "Pengulangan", doesNotRepeat: "Tidak berulang", everyDay: "Setiap Hari", everyWeek: "Setiap Minggu", everyMonth: "Setiap Bulan", everyYear: "Setiap Tahun", saveRecurringPrompt: "Bagaimana Anda ingin menyimpan perubahan Anda?", saveThisOnly: "Hanya acara ini", saveThisAndFuture: "Acara ini dan selanjutnya", saveAllInSeries: "Semua acara dalam seri", deleteRecurringPrompt: "Ini adalah acara berulang. Instans mana yang ingin Anda hapus?", deleteThisOnly: "Hanya acara ini", deleteThisAndFuture: "Acara ini dan selanjutnya", deleteAllInSeries: "Semua acara dalam seri", confirmDeleteEventMessage: "Menghapus sebuah acara juga akan menghapus semua tugas yang terkait.", confirmUnsavedMessage: "Anda memiliki perubahan yang belum disimpan. Apakah Anda yakin ingin membuangnya?", keepEditing: "Tetap Mengedit", discard: "Buang", manageModalTitle: "Kelola", newCategoryPlaceholder: "Nama kategori baru", dragAndDropHint: "Seret dan lepas untuk menyusun ulang kalender dan menempatkannya ke dalam kategori.", addCalendarNamePlaceholder: "Nama Kalender (Wajib)", confirmDeleteCalendarMessage: "Ini akan menghapus kalender dan semua acaranya secara permanen. Tindakan ini tidak dapat dibatalkan." },
  ...
  tlh: {
    ...
    settings: { language: "Hol", theme: "Tema'", dark: "qIj", light: "leS", default: "Default", monochrome: "mI' sor", back: "AppDaq jImev" },
...
export const AppProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
  ...
  const [theme, setTheme] = useLocalStorage<Theme>('kairo-theme', 'default');
