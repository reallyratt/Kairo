...
export type Theme = 'dark' | 'light' | 'cute' | 'monochrome';
...
const translations: Record<Language, Record<string, any>> = {
  en: {
    ...
    settings: { language: "Language", theme: "Theme", dark: "Dark", light: "Light", cute: "Cute", monochrome: "Monochrome", back: "Back to the App" },
  ...
  id: {
    ...
    settings: { language: "Bahasa", theme: "Tema", dark: "Gelap", light: "Terang", cute: "Imut", monochrome: "Monokrom", back: "Kembali ke Aplikasi" },
  ...
  tlh: {
    ...
    settings: { language: "Hol", theme: "Tema'", dark: "qIj", light: "leS", cute: "yIn", monochrome: "mI' sor", back: "AppDaq jImev" },
